...
from models import PVNet2, PVNet2_v4, PVNet2_v5, PVNet2_v6, PVNet2_v7, PVNet2_v8, PVNet2_v9, PVNet2_v10, PVNet2_vv0
...
def main():
    ...
    # val_loader = DataLoader(val_dataset, batch_size=config.pv_net.train.batch_sz_res,
    #                         num_workers=config.num_workers,shuffle=True, drop_last=True)
